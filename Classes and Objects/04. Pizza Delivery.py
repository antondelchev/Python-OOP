class PizzaDelivery:
    ...
    def add_extra(self, ingredient, quantity, price_per_ingredient):
        ...
        elif self.ingredients.get(ingredient):
    ...
    def remove_ingredient(self, ingredient, quantity, price_per_ingredient):
        if self.ordered:
            return f"Pizza {self.name} already prepared, and we can't make any changes!"
        elif not self.ingredients.get(ingredient):
            return f"Wrong ingredient selected! We do not use {ingredient} in {self.name}!"
        elif self.ingredients.get(ingredient) and self.ingredients[ingredient] < quantity:
